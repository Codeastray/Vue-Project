<template>
   <form class="form-control max-sm:p-5" @submit.prevent="handleSubmit">
      ...
      <div class="flex w-full flex-col items-center justify-center" @drop.prevent="onDrop" @dragover.prevent>
         ...
         <h2 v-if="thumbnailPreview">
            照片預覽 <img class="mx-auto w-52 object-cover" :src="thumbnailPreview" alt="" />
         </h2>
         <label
            for="dropzone-file"
            class="mt-7 flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100">
            <div class="flex flex-col items-center justify-center pb-6 pt-5">
               ...
               <p class="mb-2 text-xl text-gray-500 dark:text-gray-400">
                  ...
                  <span class="block text-center max-sm:hidden">或拖曳圖片</span>
               </p>
